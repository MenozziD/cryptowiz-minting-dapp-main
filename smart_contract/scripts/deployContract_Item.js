...
const BASE_URI = 'ipfs://Qmb1XBc2VTJH6CYR2eCZTMTMRuTEin6c5vhiAz9V8F9GmR/'
...
async function main() {
  ...
  // Deploy the contract
  const CryptoWiz = await hre.ethers.getContractFactory('CryptoWiz_ITMb')
  const cryptoWiz = await CryptoWiz.deploy(BASE_URI)
