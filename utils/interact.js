...
const whitelist = require('../smart_contract/scripts/whitelist.js')

const web3 = createAlchemyWeb3(process.env.NEXT_PUBLIC_ALCHEMY_RPC_URL)
import { config } from '../dapp.config'

const contract = require('../smart_contract/artifacts/contracts/CryptoWiz_PGb.sol/CryptoWiz_PGb.json')
