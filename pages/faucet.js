    ...
    <div className="min-h-screen h-full w-full overflow-hidden flex flex-col items-center justify-center bg-brand-background ">
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-5">
          <div className="relative z-1 md:max-w-4xl w-full bg-purple-700/30 filter backdrop-blur-sm py-4 rounded-2xl px-2 md:px-10 flex flex-col items-center">
